...
const resources = {
  "pt-BR": {
    translation: {
      ...
      history_share_unavailable_message:
      ...
      settings_clear_history_message:
      ...
      settings_theme_alert_message:
        "Suporte a tema claro/escuro será adicionado em breve.",

      settings_language_alert_title: "Em breve",
      settings_language_alert_message:
      ...
      onboarding_slide_1_subtitle:
        "Comprima, converta e organize arquivos com facilidade.",

      onboarding_slide_2_title: "Ferramentas inteligentes",
      onboarding_slide_2_subtitle:
        "OCR, IA e ações rápidas em uma experiência simples.",
      ...
      onboarding_slide_4_subtitle:
        "Processe e compartilhe o resultado rapidamente.",
      ...
      action_sub_batch: "Selecione até {{limit}} arquivos no plano grátis.",
      ...
      action_sign_screen_subtitle: "Desenhe sua assinatura e toque em Salvar",
      ...
      // ALERTS — sucesso
      // ─────────────────────────────────────────
      alert_compress_title: "PDF comprimido",
      alert_compress_message: "Seu PDF foi comprimido com sucesso.",
  ...
  en: {
    translation: {
      ...
      history_subtitle: "Search, organize, and share your PDFs",
      history_clear: "Clear",
      history_search_placeholder: "Search PDF...",

      history_sort_recent: "Recent",
      history_sort_name: "Name",
      history_sort_size: "Size",
      history_select: "Select",

      history_selected_count: "{{count}} selected",
      history_share: "Share",
      history_delete: "Delete",

      history_empty_title: "No files yet",
      history_empty_subtitle: "Your PDFs will appear here",
      ...
      history_size_unknown: "Unknown size",
      history_possible_duplicate: "Possible duplicate",
      history_already_opened: "Already opened",

      history_unavailable_title: "Unavailable",
      history_open_unavailable_message: "Could not open this file.",
      history_share_unavailable_message: "Could not share this file.",
      history_open_pdf_title: "Open PDF",
      history_share_pdf_title: "Share PDF",

      history_remove_title: "Remove file",
      history_remove_message: "Do you want to delete this item?",

      history_delete_selected_title: "Delete selected",
      history_delete_selected_message: "Do you want to delete {{count}} file(s)?",

      history_clear_title: "Clear history",
      history_clear_message: "Choose an option:",
      history_clear_all: "Clear all",
      history_remove_duplicates: "Remove duplicates",
      history_remove_old: "Remove old items (+30 days)",
      ...
      premium_hero_title: "PDF Toolkit Premium",
      premium_hero_text:
        "Process without limits, without interruptions, and with full privacy.",
      ...
      settings_clear_history_message:
        "Are you sure? Your file history will be deleted.",
      ...
      onboarding_slide_1_subtitle:
        "Compress, convert, and organize files with ease.",

      onboarding_slide_2_title: "Smart tools",
      onboarding_slide_2_subtitle:
        "OCR, AI, and quick actions in a simple experience.",
      ...
      action_sub_batch: "Select up to {{limit}} files on the free plan.",
      action_sub_preview: "Open, review, and share your PDF.",
      action_sub_premium: "Unlock unlimited processing and advanced tools.",
